...
/**
 * Repositório de produtos — guarda todos os produtos em memória.
 * Já vem com produtos de exemplo pré-carregados.
 */
public class ProdutoRepositorio {
    ...
    /**
     * Produtos de exemplo que aparecem logo ao iniciar o programa.
     */
